...
const UmapScatter: React.FC<ScatterPlotProps> = ({ data, color, controlPanel,loader }) => {
  ...
  return (
    <ResponsiveCardVegaLite
      ...
      isStatic={false}
      title={`UMAP Plot`}
      details={"This scatter plot visualizes high-dimensional data reduced to two dimensions using UMAP (Uniform Manifold Approximation and Projection). Each point represents a sample, clustered based on similarity. Use this plot to explore the structure and patterns in your dataset."}
